...
# Was initially messing around with batch_size, but gives error with shape checks in linmod... will double check later...
# # Test different batch sizes
# # exit()
# batch_sizes = [1, 10, 50, len(X_train)]
...
#     plt.plot(all_params)
#     plt.ylabel(f"batch_size = {batch_sizes}\n\nModel Weight")
#     plt.xlabel("Epoch")
#     if i == 0: plt.title("Model Param")
