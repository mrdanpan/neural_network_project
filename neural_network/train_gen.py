...
def MBGD(X_train, y_train, model, loss_class, optimizer, batch_size = 10, nb_epochs = 100, seed = None, verbose = True):
    # TODO: allow uneven batches -> append last batch with 0s. 
    return
    # all_losses = []
